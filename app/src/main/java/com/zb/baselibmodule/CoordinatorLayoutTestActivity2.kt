...
import com.zb.baselibmodule.databinding.ActivityCoordinatorLayoutTest2Binding
 ...
 */
class CoordinatorLayoutTestActivity2: BaseBindingActivity<ActivityCoordinatorLayoutTest2Binding>() {
    ...
    override fun initBinding(): ActivityCoordinatorLayoutTest2Binding {
        return ActivityCoordinatorLayoutTest2Binding.inflate(layoutInflater)
    }
